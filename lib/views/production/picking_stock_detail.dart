      ...
      for (var element in hobby) {
        ...
        if (element[5]['isHide']) {
          ...
          if (element[0]['value']['value'] == scanCode[0] &&
              element[4]['value']['value'] == barCodeScan[6]) {
