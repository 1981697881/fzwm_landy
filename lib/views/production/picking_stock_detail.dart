    ...
    if (orderDate.length > 0) {
      ...
      orderDate.forEach((value) {
        ...
        arr.add({
          ...
          "name": "FStockID",
          "isHide": false,
          "value": {"label": value[16], "value": value[15]}
        });
        arr.add({
          "title": "批号",
          "name": "FLot",
