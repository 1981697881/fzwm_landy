      ...
      /*orderDate.forEach((value) {*/
        ...
        if (stocks.length > 0) {
          if (stocks[0][4] != null) {
            ...
            stockLocMap['FormId'] = 'STK_InStock';
            stockLocMap['FieldKeys'] =
                'FStockLocId.'+stocks[0][4] +'.FNumber';
            stockLocMap['FilterString'] = "FID = " + value[14].toString() + " and FInStockEntry_FEntryId =" + value[4].toString();
